...
class Placement_Drive 
{
    ...
    { 
       ...
       String course[] = {"Btech", "Mtech", "Btech", "Btech","Btech"}; 
		...
		for (int j = 0; j < c.length; j++)
		{
			if(c[j].equals(f_course))
			{
				for (int i = 0; i < n; i++) 
				{
					...
					{
						count++;
						System.out.println(count+". Name : "+data.name+" Course_Name : "+data.course+" Registration : "+data.reg_no+" CGPA : "+data.cgpa+" Placemant Status : "+data.status); 
